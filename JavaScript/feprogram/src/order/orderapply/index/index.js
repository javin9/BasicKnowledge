...
import check from "libs/check";
  ...
  let isfirstClickSubmit = true;
    ...
    if(window.isFromShopCGBBank){
        ...
        var $maskLayer ='<div style="position: fixed;width: 100%;height: 100%;background: #000;top: 0;left: 0;filter: alpha(opacity=40);-moz-opacity: .4;opacity: .4;z-index: 88888;"></div>'
