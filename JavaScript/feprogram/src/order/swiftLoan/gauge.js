...
(function() {
  ...
  Gauge = (function(_super) {
    ...
    Gauge.prototype.paddingBottom = 0.35;
    ...
    Gauge.prototype.setOptions = function(options) {
      ...
      this.radius = this.canvas.height * (1 - 0.42) - this.lineWidth;
      this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height);
      this.render();
      _ref1 = this.gp;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
    ...
    Gauge.prototype.render = function() {
	  ...
	  document.getElementById("spedz2").innerHTML="<span>"+parseInt(this.displayedValue)+"</span>元";
	  ...
	  if(this.yImgLoaded){
		...
		this.ctx.translate(-gauge.x, -gauge.y);
		this.ctx.drawImage(this.yImg,gauge.x-11,gauge.y-25,22,25);
		this.ctx.restore();
	  }
  ...
  window.AnimationUpdater = {
    ...
    run: function() {
      ...
      if (!animationFinished) {
		...
		//clearInterval(pgxx);
		document.getElementById("spedz1").innerHTML="恭喜您获得";
		//$("#FinishData").html("查看订单").css("background-color","#ff9900");
      }
    }
  };
