...
class Insurance extends React.Component {
  ...
  propsMapToState(props){
    const glassOptions = [
      {label : '国产', value: Math.round(props.price*0.001235)},
      {label : '进口', value: Math.round(props.price*0.002015)}
    ]
    ...
    return {
      ...
      // 三者20万
      t20: Math.round(812.53),

      // 三者50万
      t50: Math.round(1100.32),

      // 司机乘客1万
      driver: Math.round(108.39),

      // 车上人员2万
      member: Math.round(216.78),

      // 划痕5000
      scratch: 370,

      // 车损
      loss : Math.round(props.price*0.02185),

      // 盗抢
      steal: Math.round(93.6+props.price*0.003445*1.20),

      // 发动机涉水
      water: Math.round(props.price*0.02185*0.05),

      // 车损无法找到第三方
      nofound: Math.round(props.price*0.02185*0.025)
    }
  }
