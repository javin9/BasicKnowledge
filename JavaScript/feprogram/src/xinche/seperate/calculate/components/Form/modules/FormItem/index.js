...
export default class FormItem extends React.Component {
  ...
  render () {
    ...
    const classname = this.props.inline ? 'FormItem FormItem-inline' : 'FormItem'
    ...
    switch(this.props.type){
      ...
      case 'carSelect':
        ...
        break
      case 'text':
       FormItemContent = <Text value={this.props.value} format={this.props.format} onChange={this.props.onChange}  disabled={this.props.disabled} disabledTheme={this.props.disabledTheme} disabledValue={this.props.disabledValue} validator={this.props.validator}/>
       break
      case 'switchSelect':
