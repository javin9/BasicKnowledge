<template>
    <div class="page-body" :class="{'editable': editable}">
        <vue-header title="在线审批"></vue-header>
...
<script>
    import vueHeader from 'libs/header/index.vue';
...
//                    console.log(fileIds)
            ...
            // 返回上一页
            prevPage: function() {
                window.location.href = '/onlineapproval/info?orderId='+tools.getUrlParam('orderId') +'&childOrderId='+ tools.getUrlParam('childOrderId');
            },
//            prevPage2:function() {
//                var cookieString = "uploadok=true;path=/;domain=" + tools.wildcardUrl();
//                document.cookie = cookieString;
//
//                window.location.href = '/onlineapproval/info?orderId='+tools.getUrlParam('orderId') +'&childOrderId='+ tools.getUrlParam('childOrderId')+'#uploaded';
//            },
            // 显示提示弹层
