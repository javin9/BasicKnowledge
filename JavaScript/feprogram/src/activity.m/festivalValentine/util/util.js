...
export function throwError(msg){
    window.location.href = home_page_url + '/Home/Error?errMsg=' + encodeURIComponent(msg)
}
...
export function page_scr_down() {
    ...
    // 对话超出容器高度后，滚动至最底部对话
    if (_dialogH >= _contH) {
        myscrollTops(_dialogH, 500, 'chattingWrap')
    }
    function myscrollTops(scrollTo, time, domId) {
